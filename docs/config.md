...
2. `App.config` or `Web.config` file
    ...
    - `OTEL_LOG_LEVEL`
    - `OTEL_DOTNET_AUTO_NETFX_REDIRECT_ENABLED` (Obsolete)
...
| `ENTITYFRAMEWORKCORE` \[5\] | [Microsoft.EntityFrameworkCore](https://www.nuget.org/packages/Microsoft.EntityFrameworkCore) **Not supported on .NET Framework**                                                                                         | ≥6.0.12                | source                   | [Experimental](https://github.com/open-telemetry/opentelemetry-specification/blob/main/specification/versioning-and-stability.md) |
...
| `KAFKA`                     | [Confluent.Kafka](https://www.nuget.org/packages/Confluent.Kafka)                                                                                                                                                         | ≥1.4.0 & < 3.0.0 \[6\] | bytecode                 | [Experimental](https://github.com/open-telemetry/opentelemetry-specification/blob/main/specification/versioning-and-stability.md) |
...
| `MONGODB`                   | [MongoDB.Driver.Core](https://www.nuget.org/packages/MongoDB.Driver.Core) / [MongoDB.Driver](https://www.nuget.org/packages/MongoDB.Driver)                                                                               | ≥2.7.0                 | source or bytecode \[7\] | [Experimental](https://github.com/open-telemetry/opentelemetry-specification/blob/main/specification/versioning-and-stability.md) |
...
| `NPGSQL` \[5\]              | [Npgsql](https://www.nuget.org/packages/Npgsql)                                                                                                                                                                           | ≥6.0.0                 | source                   | [Experimental](https://github.com/open-telemetry/opentelemetry-specification/blob/main/specification/versioning-and-stability.md) |
...
| `RABBITMQ`                  | [RabbitMQ.Client](https://www.nuget.org/packages/RabbitMQ.Client/)                                                                                                                                                        | ≥5.0.0                 | source or bytecode \[8\] | [Experimental](https://github.com/open-telemetry/opentelemetry-specification/blob/main/specification/versioning-and-stability.md) |
...
\[5\]: When both `ENTITYFRAMEWORKCORE` and `NPGSQL` traces instrumentations are
...
\[6\]: `Confluent.Kafka` is supported from version ≥1.8.2 on ARM64
       for Windows and Linux, and ≥1.9.2 on macOS.

\[7\]: `MongoDB.Driver` needs bytecode instrumentation only for < `3.7.0`
        versions, `3.7.0+` uses only source instrumentation.

\[8\]: `RabbitMq.Client` needs bytecode instrumentation only for `5.*` and `6.*`
        versions, `7.0.0+` uses only source instrumentation.

\[9\]: `System.Data.SqlClient` is [deprecated](https://www.nuget.org/packages/System.Data.SqlClient/4.9.0#readme-body-tab).

\[10\]: `Microsoft.Data.SqlClient` v3.* is not supported on .NET Framework,
...
| `OTEL_DOTNET_AUTO_NETFX_REDIRECT_ENABLED`           | **Obsolete. .NET Framework only.** Fallback for `OTEL_DOTNET_AUTO_REDIRECT_ENABLED` when the primary variable is not set. Use `OTEL_DOTNET_AUTO_REDIRECT_ENABLED` instead.                                                                                                                                                                                                                         |               | [Experimental](https://github.com/open-telemetry/opentelemetry-specification/blob/main/specification/versioning-and-stability.md) |
| `OTEL_DOTNET_AUTO_REDIRECT_ENABLED`                 | Enables redirection of assembly references to versions not lower than those used by the automatic instrumentation. **Defaults to `true` for standalone deployments and `false` for non-standalone deployments (for example, NuGet package deployments). See [Assembly Conflict Resolution](./assembly-conflict-resolution.md) for details.**                                                       | Varies        | [Experimental](https://github.com/open-telemetry/opentelemetry-specification/blob/main/specification/versioning-and-stability.md) |
