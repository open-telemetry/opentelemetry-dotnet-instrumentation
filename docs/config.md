...
| `MONGODB`             | [MongoDB.Driver.Core](https://www.nuget.org/packages/MongoDB.Driver.Core) / [MongoDB.Driver](https://www.nuget.org/packages/MongoDB.Driver)                                                                               | ≥2.7.0                 | source or bytecode \[6\] | [Experimental](https://github.com/open-telemetry/opentelemetry-specification/blob/main/specification/versioning-and-stability.md) |
...
| `RABBITMQ`            | [RabbitMQ.Client](https://www.nuget.org/packages/RabbitMQ.Client/)                                                                                                                                                        | ≥5.0.0                 | source or bytecode \[7\] | [Experimental](https://github.com/open-telemetry/opentelemetry-specification/blob/main/specification/versioning-and-stability.md) |
...
\[6\]: `MongoDB.Driver` needs bytecode instrumentation only for < `3.7.0`
        versions, `3.7.0+` uses only source instrumentation.

\[7\]: `RabbitMq.Client` needs bytecode instrumentation only for `5.*` and `6.*`
        versions, `7.0.0+` uses only source instrumentation.

\[8\]: `System.Data.SqlClient` is [deprecated](https://www.nuget.org/packages/System.Data.SqlClient/4.9.0#readme-body-tab).

\[9\]: `Microsoft.Data.SqlClient` v3.* is not supported on .NET Framework,
