...
| `OTEL_DOTNET_AUTO_RABBITMQ_CAPTURE_VHOST_AND_CLUSTER_NAME`                        | Whether the RabbitMQ instrumentation can capture the vhost and cluster name as the `messaging.rabbitmq.vhost.name` and `messaging.rabbitmq.cluster.name` attributes. Neither is part of the messaging semantic conventions yet.          | `false`       | [Experimental](https://github.com/open-telemetry/opentelemetry-specification/blob/main/specification/versioning-and-stability.md) |
