...
| `STACKEXCHANGEREDIS`        | [StackExchange.Redis](https://www.nuget.org/packages/StackExchange.Redis)                                                                                                                                                  | \[15\]                 | source & bytecode         | [Experimental](https://github.com/open-telemetry/opentelemetry-specification/blob/main/specification/versioning-and-stability.md) |
...
\[13\]: `Microsoft.Data.SqlClient` v3.* is not supported on .NET Framework,
...
\[15\]: `StackExchange.Redis` versions ≥2.6.122 & < 4.0.0 are
