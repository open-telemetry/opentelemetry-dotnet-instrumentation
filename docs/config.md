...
| `WCFSERVICE`          | [System.ServiceModel](https://www.nuget.org/packages/System.ServiceModel) **Supported on .NET Framework**.                                                                                      | ≥4.0.0.0 < 5.0.0.0 | source & bytecode       | [Experimental](https://github.com/open-telemetry/opentelemetry-specification/blob/main/specification/versioning-and-stability.md) |
