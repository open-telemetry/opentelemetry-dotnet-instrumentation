...
| `XMS`                       | [IBMXMSDotnetClient](https://www.nuget.org/packages/IBMXMSDotnetClient) **Not supported on .NET Framework**                                                                                                                | ≥9.0.0 & < 11.0.0      | bytecode                  | [Experimental](https://github.com/open-telemetry/opentelemetry-specification/blob/main/specification/versioning-and-stability.md) |
