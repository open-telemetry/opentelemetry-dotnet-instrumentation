...
1. Change the `OpenTelemetry.ClrProfiler.Instrumentation.Initialize()` method
...
1. Try auto-instrumentation using ActivitySource
   e.g. in `OpenTelemetry.ClrProfiler.AutoInstrumentation.Http.HttpClient.HttpMessageHandlerCommon`.
