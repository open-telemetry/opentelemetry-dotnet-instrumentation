...
1. Change the `OpenTelemetry.AutoInstrumentation.Instrumentation.Initialize()` method
...
1. Try auto-instrumentation using ActivitySource
   e.g. in `OpenTelemetry.AutoInstrumentation.Http.HttpClient.HttpMessageHandlerCommon`.
