...
| `OTEL_INSTRUMENTATION_HTTPCLIENT_ENABLED` | Defines whether the HttpClient instrumentation is enabled. | `true` |
| `OTEL_INSTRUMENTATION_ASPNET_ENABLED` | Defines whether the ASP.NET instrumentation is enabled. | `true` |
| `OTEL_INSTRUMENTATION_SQLCLIENT_ENABLED` | Defines whether the SqlClient instrumentation is enabled. | `true` |
