...
```sh
curl -sSfL https://raw.githubusercontent.com/open-telemetry/opentelemetry-dotnet-instrumentation/v0.5.0-beta.1/otel-dotnet-auto-install.sh -O
...
| `VERSION`               | Version to download                                              | No       | `v0.5.0-beta.1`           |
...
$module_url = "https://raw.githubusercontent.com/open-telemetry/opentelemetry-dotnet-instrumentation/v0.5.0-beta.1/OpenTelemetry.DotNet.Auto.psm1"
