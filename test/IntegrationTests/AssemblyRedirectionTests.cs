...
{
    private const string DiagnosticSourceAssemblyName = "System.Diagnostics.DiagnosticSource";
    private const string LoggingAbstractionsAssemblyName = "Microsoft.Extensions.Logging.Abstractions";

    [Theory]
    [Trait("Category", "EndToEnd")]
#if NET8_0
    // Case 1: Lower version should be redirected with/without native profiler
    [InlineData("8.0.0", DiagnosticSourceAssemblyName, "10.0.0.0", "10.0.25.52411", true)]
    [InlineData("8.0.0", DiagnosticSourceAssemblyName, "10.0.0.0", "10.0.25.52411", false)]
    // Case 2: Equal version, should NOT be redirected with/without native profiler
    [InlineData("10.0.0", DiagnosticSourceAssemblyName, "10.0.0.0", "10.0.25.52411", true)]
    [InlineData("10.0.0", DiagnosticSourceAssemblyName, "10.0.0.0", "10.0.25.52411", false)]
...
#elif NET9_0
    // Case 1: Lower version should be redirected with/without native profiler
    [InlineData("9.0.0", DiagnosticSourceAssemblyName, "10.0.0.0", "10.0.25.52411", true)]
    [InlineData("9.0.0", DiagnosticSourceAssemblyName, "10.0.0.0", "10.0.25.52411", false)]
    // Case 2: Equal version, should NOT be redirected with/without native profiler
    [InlineData("10.0.0", DiagnosticSourceAssemblyName, "10.0.0.0", "10.0.25.52411", true)]
    [InlineData("10.0.0", DiagnosticSourceAssemblyName, "10.0.0.0", "10.0.25.52411", false)]
    // Case 3: Higher version should NOT be redirected with/without native profiler
    ...
    [InlineData("10.0.2", DiagnosticSourceAssemblyName, "10.0.0.0", "10.0.526.15411", true)]
    [InlineData("10.0.2", DiagnosticSourceAssemblyName, "10.0.0.0", "10.0.526.15411", false)]
    ...
    [InlineData("6.0.0", LoggingAbstractionsAssemblyName, "10.0.0.2", "10.0.225.61305")]
    // Case 2: Equal version should keep loading the expected entrypoint assembly (native profiler mandatory)
    [InlineData("10.0.2", LoggingAbstractionsAssemblyName, "10.0.0.2", "10.0.225.61305")]
    // Case 3: Higher version is not possible for DiagnosticSource on .NET 10, the instrumentation tool is already using the highest possible version
#endif
