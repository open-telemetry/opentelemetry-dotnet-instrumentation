    ...
    public class Program
    {
        public static async Task Main()
        {
            ...
            finally
            {
                ...
                var tracerAssemblyLocation = Type.GetType("Datadog.Trace.Tracer, OpenTelemetry.Instrumentation")?.Assembly.Location ?? "(none)";
                ...
                Console.WriteLine($"OpenTelemetry.Instrumentation.dll path: {tracerAssemblyLocation}");
                Console.WriteLine($"OpenTelemetry.Instrumentation.ClrProfiler.Managed.dll path: {clrProfilerAssemblyLocation}");
