...
namespace Datadog.Trace.Tests.Configuration
{
    ...
    public class ConfigurationSourceTests
    {
        ...
        public static IEnumerable<object[]> GetTestData()
        {
            ...
            yield return new object[] { "OPENTELEMETRY_SERVICE_NAME", "web-service", CreateFunc(s => s.ServiceName), "web-service" };
            ...
            yield return new object[] { "OPENTELEMETRY_TRACE_GLOBAL_TAGS", "k1:v1, k2:v2", CreateFunc(s => s.GlobalTags), TagsK1V1K2V2 };
        ...
        {
            // Extra opening brace
            yield return new object[] { @"{ ""OPENTELEMETRY_TRACE_GLOBAL_TAGS"": { { ""name1"":""value1"", ""name2"": ""value2""} }" };
        }
        ...
        public static IEnumerable<object[]> GetBadJsonTestData3()
        {
            ...
            yield return new object[] { @"{ ""OPENTELEMETRY_TRACE_GLOBAL_TAGS"": { ""name1"": { ""name2"": [ ""vers"" ] } } }", CreateFunc(s => s.GlobalTags.Count), 0 };
        }
