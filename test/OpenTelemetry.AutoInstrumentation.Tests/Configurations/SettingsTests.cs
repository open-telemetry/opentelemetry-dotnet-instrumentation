...
public class SettingsTests : IDisposable
{
    ...
    [InlineData("non-supported", new[] { TracesExporter.None })]
    [InlineData("otlp", new[] { TracesExporter.Otlp })]
    [InlineData("zipkin", new[] { TracesExporter.Zipkin })]
    [InlineData(",otlp,", new[] { TracesExporter.Otlp })]
    [InlineData("zipkinnm", new[] { TracesExporter.None })]
    ...
    [InlineData("non-supported, none", new[] { TracesExporter.None })]
    ...
    [InlineData("non-supported", new[] { MetricsExporter.None })]
    [InlineData("otlp", new[] { MetricsExporter.Otlp })]
    [InlineData("prometheus", new[] { MetricsExporter.Prometheus })]
    [InlineData(",otlp,", new[] { MetricsExporter.Otlp })]
    [InlineData("prometheusss", new[] { MetricsExporter.None })]
    ...
    [InlineData("non-supported, none", new[] { MetricsExporter.None })]
    ...
    [InlineData("non-supported", new[] { LogExporter.None })]
