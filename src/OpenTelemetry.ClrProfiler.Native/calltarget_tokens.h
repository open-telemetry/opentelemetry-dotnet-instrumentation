...
class CallTargetTokens {
 private:
  ...
  WSTRING managed_profiler_calltarget_type = WStr("OpenTelemetry.ClrProfiler.CallTarget.CallTargetInvoker");
  ...
  WSTRING managed_profiler_calltarget_statetype = WStr("OpenTelemetry.ClrProfiler.CallTarget.CallTargetState");
  WSTRING managed_profiler_calltarget_statetype_getdefault_name =WStr("GetDefault");

  WSTRING managed_profiler_calltarget_returntype = WStr("OpenTelemetry.ClrProfiler.CallTarget.CallTargetReturn");
  WSTRING managed_profiler_calltarget_returntype_getdefault_name = WStr("GetDefault");

  WSTRING managed_profiler_calltarget_returntype_generics = WStr("OpenTelemetry.ClrProfiler.CallTarget.CallTargetReturn`1");
