...
HRESULT STDMETHODCALLTYPE CorProfiler::Initialize(IUnknown* cor_profiler_info_unknown)
{
    ...
    {
        Logger::Warn("OpenTelemetry TRACER DIAGNOSTICS - Profiler disabled: .NET 5.0 runtime or greater is required on this "
                     "architecture.");
        return E_FAIL;
    }
#endif
    ...
    if (IsAzureAppServices())
    {
        ...
        {
            Logger::Info("OpenTelemetry TRACER DIAGNOSTICS - Profiler disabled: ", environment::azure_app_services_app_pool_id, " ",
        ...
        {
            Logger::Info("OpenTelemetry TRACER DIAGNOSTICS - Profiler disabled: ", app_pool_id_value,
