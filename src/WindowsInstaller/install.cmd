...
set DATADOG_APPCMD_CMDLINE=%systemroot%\system32\inetsrv\appcmd.exe set config /section:system.webServer/modules /+[name='OpenTelemetryInstrumentationModule',type='Datadog.Trace.AspNet.TracingHttpModule,OpenTelemetry.AutoInstrumentation.AspNet,Version=1.0.0.0,Culture=neutral,PublicKeyToken=def86d061d0d2eeb',preCondition='managedHandler,runtimeVersionv4.0']
