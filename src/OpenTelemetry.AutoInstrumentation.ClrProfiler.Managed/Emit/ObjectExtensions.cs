...
namespace OpenTelemetry.AutoInstrumentation.ClrProfiler.Emit
{
    /// <summary>
    ...
    internal static class ObjectExtensions
    {
        ...
        {
#if NETFRAMEWORK
            var asm = AppDomain.CurrentDomain.DefineDynamicAssembly(new AssemblyName("OpenTelemetry.AutoInstrumentation.ClrProfiler.Emit.DynamicAssembly"), AssemblyBuilderAccess.Run);
#else
            var asm = AssemblyBuilder.DefineDynamicAssembly(new AssemblyName("OpenTelemetry.AutoInstrumentation.ClrProfiler.Emit.DynamicAssembly"), AssemblyBuilderAccess.Run);
#endif
