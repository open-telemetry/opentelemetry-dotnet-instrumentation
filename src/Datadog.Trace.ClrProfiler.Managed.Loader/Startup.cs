...
{
    /// <summary>
    /// A class that attempts to load the OpenTelemetry.Instrumentation.ClrProfiler.Managed .NET assembly.
    /// </summary>
    public partial class Startup
    {
        /// <summary>
        /// Initializes static members of the <see cref="Startup"/> class.
        /// This method also attempts to load the OpenTelemetry.Instrumentation.ClrProfiler.Managed .NET assembly.
        /// </summary>
        static Startup()
        {
        ...
        private static void TryLoadManagedAssembly()
        {
            try
            {
                var assembly = Assembly.Load("OpenTelemetry.Instrumentation.ClrProfiler.Managed, Version=1.23.0.0, Culture=neutral, PublicKeyToken=def86d061d0d2eeb");
