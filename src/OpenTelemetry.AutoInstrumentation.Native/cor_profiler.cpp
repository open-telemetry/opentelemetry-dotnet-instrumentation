...
HRESULT CorProfiler::GenerateCallTargetTrampolineType(const ModuleID module_id)
{
    ...
    auto profilerAssemblyName = GetBytecodeInstrumentationAssembly();
    ...
    mdMethodDef return_ctor, get_return_value_method;
    {
        ...
        ILRewriter rewriter(this->info_, nullptr, module_id, return_ctor);
        ...
        ILRewriter getRewriter(this->info_, nullptr, module_id, get_return_value_method);
    ...
    auto define_holder_cctor = [&](mdTypeDef holderType,
        ...
        ILRewriter rewriter(this->info_, nullptr, module_id, cctor);
        rewriter.InitializeTiny();
        ILInstr* p = rewriter.GetILList()->m_pNext;
    ...
    auto define_holder_method = [&](mdTypeDef holderType,
        ...
        ILRewriter rewriter(this->info_, nullptr, module_id, method);
        rewriter.InitializeTiny();
        ILInstr* p = rewriter.GetILList()->m_pNext;
