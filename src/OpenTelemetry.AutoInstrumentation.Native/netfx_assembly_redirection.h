...
void CorProfiler::InitNetFxAssemblyRedirectsMap()
{
    ...
    assembly_version_redirect_map_.insert({
        ...
        { L"OpenTelemetry.Instrumentation.AspNet", {1, 8, 0, 11} },
        { L"OpenTelemetry.Instrumentation.AspNet.TelemetryHttpModule", {1, 8, 0, 11} },
        ...
        { L"OpenTelemetry.Instrumentation.Runtime", {1, 8, 1, 5} },
        { L"OpenTelemetry.Instrumentation.SqlClient", {1, 0, 0, 0} },
        { L"OpenTelemetry.Instrumentation.Wcf", {1, 0, 0, 16} },
        { L"OpenTelemetry.Resources.Azure", {1, 0, 0, 124} },
        { L"OpenTelemetry.Resources.Host", {0, 1, 0, 116} },
        { L"OpenTelemetry.Resources.Process", {0, 1, 0, 112} },
        { L"OpenTelemetry.Resources.ProcessRuntime", {0, 1, 0, 108} },
