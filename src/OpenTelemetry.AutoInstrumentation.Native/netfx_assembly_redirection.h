...
void CorProfiler::InitNetFxAssemblyRedirectsMap()
{
    ...
    assembly_version_redirect_map_.insert({
        ...
        { L"Microsoft.Extensions.Configuration.Binder", {9, 0, 0, 1} },
        { L"Microsoft.Extensions.DependencyInjection", {9, 0, 0, 1} },
        { L"Microsoft.Extensions.DependencyInjection.Abstractions", {9, 0, 0, 1} },
        { L"Microsoft.Extensions.Diagnostics.Abstractions", {9, 0, 0, 1} },
        { L"Microsoft.Extensions.Logging", {9, 0, 0, 1} },
        { L"Microsoft.Extensions.Logging.Abstractions", {9, 0, 0, 1} },
        { L"Microsoft.Extensions.Logging.Configuration", {9, 0, 0, 1} },
        { L"Microsoft.Extensions.Options", {9, 0, 0, 1} },
        { L"Microsoft.Extensions.Options.ConfigurationExtensions", {9, 0, 0, 1} },
        ...
        { L"OpenTelemetry.Instrumentation.AspNet", {1, 11, 0, 339} },
        { L"OpenTelemetry.Instrumentation.AspNet.TelemetryHttpModule", {1, 11, 0, 339} },
        { L"OpenTelemetry.Instrumentation.GrpcNetClient", {1, 11, 0, 342} },
        { L"OpenTelemetry.Instrumentation.Http", {1, 11, 0, 337} },
        { L"OpenTelemetry.Instrumentation.Process", {1, 11, 0, 343} },
        { L"OpenTelemetry.Instrumentation.Quartz", {1, 11, 0, 344} },
        { L"OpenTelemetry.Instrumentation.Runtime", {1, 11, 0, 345} },
        { L"OpenTelemetry.Instrumentation.SqlClient", {1, 11, 0, 346} },
        { L"OpenTelemetry.Instrumentation.Wcf", {1, 11, 0, 338} },
        { L"OpenTelemetry.Resources.Azure", {1, 11, 0, 348} },
        { L"OpenTelemetry.Resources.Host", {1, 11, 0, 352} },
        { L"OpenTelemetry.Resources.OperatingSystem", {1, 11, 0, 350} },
        { L"OpenTelemetry.Resources.Process", {1, 11, 0, 351} },
        { L"OpenTelemetry.Resources.ProcessRuntime", {1, 11, 0, 353} },
        ...
        { L"System.Text.Encodings.Web", {9, 0, 0, 1} },
        { L"System.Text.Json", {9, 0, 0, 1} },
