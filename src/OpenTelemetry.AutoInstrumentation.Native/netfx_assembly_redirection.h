...
void CorProfiler::InitNetFxAssemblyRedirectsMap()
{
    ...
    assembly_version_redirect_map_.insert({
        { 462, {
            ...
            { L"OpenTelemetry.Instrumentation.AspNet", {1, 15, 1, 919} },
            { L"OpenTelemetry.Instrumentation.AspNet.TelemetryHttpModule", {1, 15, 1, 919} },
            ...
            { L"OpenTelemetry.Instrumentation.SqlClient", {1, 15, 0, 918} },
            ...
            { L"OpenTelemetry.Resources.Host", {1, 15, 0, 917} },
