...
void CorProfiler::InitNetFxAssemblyRedirectsMap()
{
    ...
    assembly_version_redirect_map_.insert({
        ...
        { L"OpenTelemetry.Instrumentation.AspNet", {1, 13, 0, 690} },
        { L"OpenTelemetry.Instrumentation.AspNet.TelemetryHttpModule", {1, 13, 0, 690} },
        ...
        { L"OpenTelemetry.Instrumentation.Wcf", {1, 13, 0, 691} },
        ...
        { L"OpenTelemetry.Resources.Process", {1, 12, 0, 505} },
        { L"OpenTelemetry.Resources.ProcessRuntime", {1, 12, 0, 506} },
