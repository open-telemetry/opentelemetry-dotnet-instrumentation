...
void CorProfiler::InitNetFxAssemblyRedirectsMap()
{
    assembly_version_redirect_map_.insert({
        ...
        { L"Microsoft.Extensions.Configuration.Binder", {7, 0, 0, 2} },
        ...
        { L"Microsoft.Extensions.Options", {7, 0, 0, 0} },
        ...
        { L"OpenTelemetry.Instrumentation.Process", {1, 0, 0, 5} },
        { L"OpenTelemetry.Instrumentation.Quartz", {1, 0, 0, 1} },
        { L"OpenTelemetry.Instrumentation.Runtime", {1, 1, 0, 4} },
