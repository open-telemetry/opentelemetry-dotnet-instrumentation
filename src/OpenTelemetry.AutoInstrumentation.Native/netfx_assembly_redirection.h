...
void CorProfiler::InitNetFxAssemblyRedirectsMap()
{
    ...
    assembly_version_redirect_map_.insert({
        ...
        { L"OpenTelemetry.Instrumentation.AspNet", {1, 11, 0, 400} },
        { L"OpenTelemetry.Instrumentation.AspNet.TelemetryHttpModule", {1, 11, 0, 400} },
        { L"OpenTelemetry.Instrumentation.GrpcNetClient", {1, 11, 0, 402} },
        { L"OpenTelemetry.Instrumentation.Http", {1, 11, 1, 407} },
        { L"OpenTelemetry.Instrumentation.Process", {1, 11, 0, 408} },
        { L"OpenTelemetry.Instrumentation.Quartz", {1, 11, 0, 409} },
        { L"OpenTelemetry.Instrumentation.Runtime", {1, 11, 1, 410} },
        { L"OpenTelemetry.Instrumentation.SqlClient", {1, 11, 0, 411} },
        { L"OpenTelemetry.Instrumentation.Wcf", {1, 11, 0, 413} },
        { L"OpenTelemetry.Resources.Azure", {1, 11, 0, 414} },
        { L"OpenTelemetry.Resources.Host", {1, 11, 0, 416} },
        { L"OpenTelemetry.Resources.OperatingSystem", {1, 11, 0, 417} },
        { L"OpenTelemetry.Resources.Process", {1, 11, 0, 418} },
        { L"OpenTelemetry.Resources.ProcessRuntime", {1, 11, 0, 419} },
