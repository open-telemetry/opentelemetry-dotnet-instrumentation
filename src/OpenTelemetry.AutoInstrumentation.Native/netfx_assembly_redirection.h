...
void CorProfiler::InitNetFxAssemblyRedirectsMap()
{
    ...
    assembly_version_redirect_map_.insert({
        ...
        { L"OpenTelemetry.Instrumentation.AspNet", {1, 10, 0, 262} },
        { L"OpenTelemetry.Instrumentation.AspNet.TelemetryHttpModule", {1, 10, 0, 262} },
        { L"OpenTelemetry.Instrumentation.GrpcNetClient", {1, 10, 0, 264} },
        ...
        { L"OpenTelemetry.Resources.OperatingSystem", {1, 10, 0, 273} },
        { L"OpenTelemetry.Resources.Process", {1, 10, 0, 274} },
        { L"OpenTelemetry.Resources.ProcessRuntime", {1, 10, 0, 275} },
