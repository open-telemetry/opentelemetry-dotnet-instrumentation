...
void CorProfiler::InitNetFxAssemblyRedirectsMap()
{
    assembly_version_redirect_map_.insert({
        ...
        { L"Microsoft.Extensions.Configuration.Binder", {7, 0, 0, 3} },
        ...
        { L"OpenTelemetry.Instrumentation.AspNet", {1, 0, 0, 8} },
        { L"OpenTelemetry.Instrumentation.AspNet.TelemetryHttpModule", {1, 0, 0, 8} },
        { L"OpenTelemetry.Instrumentation.GrpcNetClient", {1, 0, 0, 0} },
        { L"OpenTelemetry.Instrumentation.Http", {1, 0, 0, 0} },
        { L"OpenTelemetry.Instrumentation.Process", {0, 5, 0, 2} },
