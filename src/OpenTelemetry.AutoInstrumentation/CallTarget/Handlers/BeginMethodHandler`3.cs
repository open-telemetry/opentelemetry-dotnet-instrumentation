// <copyright file="BeginMethodHandler`3.cs" company="OpenTelemetry Authors">
...
internal static class BeginMethodHandler<TIntegration, TTarget, TArg1, TArg2, TArg3>
{
    ...
    {
        return new CallTargetState(Activity.Current, _invokeDelegate(instance, arg1, arg2, arg3));
    }
}
