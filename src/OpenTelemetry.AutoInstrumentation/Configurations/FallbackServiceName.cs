// <copyright file="FallbackServiceName.cs" company="OpenTelemetry Authors">
...
internal static class FallbackServiceName
{
    private static string GetFallbackServiceName()
    {
#if NETFRAMEWORK
