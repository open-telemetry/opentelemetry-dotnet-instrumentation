...
/// <summary>
/// NLog integration for NLog 6.x (with wrapperType parameter).
...
[InstrumentMethod(
    ...
    parameterTypeNames: new[] { ClrNames.Type, "NLog.LogEventInfo", "NLog.Internal.ITargetWithFilterChain" },
    minimumVersion: "6.0.0",
    maximumVersion: "6.*.*",
    integrationName: "NLog",
    type: InstrumentationType.Log)]
public static class WriteLogEventToTargetsWithWrapperTypeIntegration
{
    /// <summary>
    /// Intercepts NLog's WriteLogEventToTargets method (with wrapperType) to inject trace context and forward to OpenTelemetry.
    /// </summary>
