...
/// <summary>
/// NLog integration for NLog 5.x (with ITargetWithFilterChain).
...
/// Later NLog 5.x versions (5.3.0+) use the ITargetWithFilterChain interface.
/// Both this integration and WriteToTargetsLegacyIntegration are registered for
...
[InstrumentMethod(
    ...
    parameterTypeNames: ["NLog.LogEventInfo", "NLog.Internal.ITargetWithFilterChain"],
    minimumVersion: "5.0.0",
    maximumVersion: "5.*.*",
    integrationName: "NLog",
    type: InstrumentationType.Log)]
public static class WriteToTargetsIntegration
{
    /// <summary>
