...
/// <summary>
/// IBM XMS message producer Send(IDestination, IMessage, DeliveryMode, int, long) instrumentation
/// </summary>
[InstrumentMethod(
    ...
    parameterTypeNames: [IntegrationConstants.DestinationInterfaceTypeName, IntegrationConstants.MessageInterfaceTypeName, IntegrationConstants.DeliveryModeTypeName, ClrNames.Int32, ClrNames.Int64],
...
public static class ProducerSendDestinationMessageWithOptionsIntegration
{
    internal static CallTargetState OnMethodBegin<TTarget, TDestination, TMessage, TDeliveryMode>(TTarget instance, TDestination destination, TMessage message, TDeliveryMode deliveryMode, int priority, long timeToLive)
