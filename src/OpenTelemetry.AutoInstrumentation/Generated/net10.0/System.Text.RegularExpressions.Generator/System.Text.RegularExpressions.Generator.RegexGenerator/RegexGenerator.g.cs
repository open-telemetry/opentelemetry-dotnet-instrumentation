...
namespace OpenTelemetry.AutoInstrumentation.Configurations.FileBasedConfiguration.Parser
{
    partial class EnvVarTypeConverter
    {
        ...
        /// </code>
        /// </remarks>
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Text.RegularExpressions.Generator", "8.0.14.26413")]
...
namespace System.Text.RegularExpressions.Generated
{
    ...
    [GeneratedCodeAttribute("System.Text.RegularExpressions.Generator", "8.0.14.26413")]
            ...
            private sealed class Runner : RegexRunner
            {
                ...
                private bool TryFindNextPossibleStartingPosition(ReadOnlySpan<char> inputSpan)
                {
                    ...
                    if (pos <= inputSpan.Length - 4)
                    {
                        ...
                        int i = inputSpan.Slice(pos).IndexOfAny(Utilities.s_indexOfString_0EB7C57F1E1613EE8D069A853AC87996AAC4AB66EE1DBD194489F3BEE08ED9A3);
                        if (i >= 0)
                        {
            ...
            private sealed class Runner : RegexRunner
            {
                ...
                private bool TryFindNextPossibleStartingPosition(ReadOnlySpan<char> inputSpan)
                {
                    ...
                    if (pos <= inputSpan.Length - 12)
                    {
                        ...
                        // If it can't be found, there's no match.
                        int i = inputSpan.Slice(pos).IndexOfAny(Utilities.s_indexOfString_C233773F5C6D603A67ECDE1B09BC1BBAC5A096FF59B079C8937C284C5834B743);
                        if (i >= 0)
                        {
                            base.runtextpos = pos + i;
                            return true;
    ...
    file static class Utilities
    {
        ...
        internal static readonly SearchValues<string> s_indexOfString_0EB7C57F1E1613EE8D069A853AC87996AAC4AB66EE1DBD194489F3BEE08ED9A3 = SearchValues.Create(["${"], StringComparison.Ordinal);
        
        /// <summary>Supports searching for the string "pipe\\MSSQL$".</summary>
        internal static readonly SearchValues<string> s_indexOfString_C233773F5C6D603A67ECDE1B09BC1BBAC5A096FF59B079C8937C284C5834B743 = SearchValues.Create(["pipe\\MSSQL$"], StringComparison.Ordinal);
    }
}
