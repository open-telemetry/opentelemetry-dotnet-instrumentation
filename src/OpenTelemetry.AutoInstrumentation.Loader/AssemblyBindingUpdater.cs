...
internal class AssemblyBindingUpdater(IOtelLogger logger, AssemblyCatalog assemblyCatalog)
{
    ...
    internal void ModifyAssemblyRedirectConfig(AppDomainSetup appDomainSetup)
    {
        try
        {
            ...
            ModifyAssemblyBinding(assemblyBinding);
    ...
    private static XElement ResolveOrAddAssemblyBinding(XDocument config)
    {
    ...
    private void ModifyAssemblyBinding(XElement assemblyBinding)
    {
