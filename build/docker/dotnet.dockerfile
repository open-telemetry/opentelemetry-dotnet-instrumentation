...
# Docker in Docker done using: https://github.com/microsoft/vscode-dev-containers/tree/master/containers/docker-in-docker
COPY build/docker/docker-in-docker-debian.sh /tmp/
RUN /bin/bash /tmp/docker-in-docker-debian.sh 
