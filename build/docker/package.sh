...
for target in integrations.json defaults.env LICENSE NOTICE ; do
    cp $DIR/../../$target $DIR/../../src/OpenTelemetry.AutoInstrumentation.ClrProfiler.Native/bin/Debug/x64/
done
cp $DIR/../../build/artifacts/createLogPath.sh $DIR/../../src/OpenTelemetry.AutoInstrumentation.ClrProfiler.Native/bin/Debug/x64/
...
for pkgtype in $PKGTYPES ; do
    fpm \
        ...
        --chdir $DIR/../../src/OpenTelemetry.AutoInstrumentation.ClrProfiler.Native/bin/Debug/x64 \
        netstandard2.0/ \
        netcoreapp3.1/ \
