    ...
    public static IReadOnlyDictionary<string, IReadOnlyCollection<PackageBuildInfo>> Versions = new Dictionary<string, IReadOnlyCollection<PackageBuildInfo>>
    {
        ...
        },
        {
            ...
            [
                ...
                new("3.9.0", supportedFrameworks: [ "net11.0", "net10.0", "net472" ]),
            ]
        },
        {
        ...
        },
        {
            ...
            [
                new("2.6.122"),
                new("2.12.14"),
                new("3.0.47-preview", supportedFrameworks: [ "net11.0", "net10.0" ]),
            ]
        },
        {
        ...
        },
        {
            ...
            [
                new("1.8.0", supportedFrameworks: [ "net11.0", "net10.0" ]),
                new("1.9.0", supportedFrameworks: [ "net11.0", "net10.0" ]),
            ]
        },
    };
}
