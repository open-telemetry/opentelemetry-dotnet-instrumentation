    ...
    public static IReadOnlyDictionary<string, IReadOnlyCollection<PackageBuildInfo>> Versions = new Dictionary<string, IReadOnlyCollection<PackageBuildInfo>>
    {
        ...
        },
        {
            ...
            [
                ...
                new("3.11.1", supportedFrameworks: [ "net11.0", "net10.0", "net9.0", "net8.0", "net472" ]),
            ]
        },
        {
        ...
        },
        {
            ...
            [
                new("2.6.122"),
                new("2.12.14"),
                new("3.0.25", supportedFrameworks: [ "net11.0", "net10.0", "net9.0", "net8.0" ]),
                new("3.1.0", supportedFrameworks: [ "net11.0", "net10.0", "net9.0", "net8.0" ]),
                new("3.1.31", supportedFrameworks: [ "net11.0", "net10.0", "net9.0", "net8.0" ]),
            ]
        },
        {
        ...
        },
        {
            ...
            [
                new("1.8.1", supportedFrameworks: [ "net11.0", "net10.0", "net9.0", "net8.0" ]),
                new("1.9.1", supportedFrameworks: [ "net11.0", "net10.0", "net9.0", "net8.0" ]),
            ]
        },
    };
}
