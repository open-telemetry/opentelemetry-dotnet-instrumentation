...
- Parameter for `ConfigureTracesOptions` extension point for StackExchnageRedis
  changed type from `OpenTelemetry.Instrumentation.StackExchangeRedis.StackExchangeRedisCallsInstrumentation`
  to `OpenTelemetry.Instrumentation.StackExchangeRedis.StackExchangeRedisCallsInstrumentationOptions`.
