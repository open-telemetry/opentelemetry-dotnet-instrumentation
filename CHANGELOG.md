...
- Raname generic environment variables to include trace.
  ...
  `OTEL_DOTNET_AUTO_ENABLED_INSTRUMENTATIONS`&#8594;`OTEL_DOTNET_AUTO_TRACE_ENABLED_INSTRUMENTATIONS`
  `OTEL_DOTNET_AUTO_DISABLED_INSTRUMENTATIONS`&#8594;`OTEL_DOTNET_AUTO_TRACE_INSTRUMENTATION_PLUGINS`
  `OTEL_DOTNET_AUTO_INSTRUMENTATION_PLUGINS`&#8594;`OTEL_DOTNET_AUTO_TRACE_INSTRUMENTATION_PLUGINS`
  `OTEL_DOTNET_AUTO_ADDITIONAL_SOURCES`&#8594;`OTEL_DOTNET_AUTO_TRACE_ADDITIONAL_SOURCES`
