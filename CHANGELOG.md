...
- Add runtime reconfiguration for continuous profiler thread and allocation
  sampling, including enabling or disabling sampling and updating sampling rates.
