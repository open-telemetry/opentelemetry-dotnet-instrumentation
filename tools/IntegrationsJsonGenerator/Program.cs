...
void UpdateNativeInstrumentationFile(string filePath, Dictionary<string, List<string>> bytecodeIntegrations)
{
    ...
    writer.Write($"// Auto-generated file, do not change it - generated by the {nameof(IntegrationsJsonGenerator)}\r\n");
    writer.Write("#ifndef BYTECODE_INSTRUMENTATIONS_H\r\n#define BYTECODE_INSTRUMENTATIONS_H\r\n");
    writer.Write("\r\n#include \"string.h\"\r\n\r\n");
    writer.Write("namespace trace\r\n{\r\n");
