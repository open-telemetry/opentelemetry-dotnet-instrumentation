    ...
    [
        ...
        new()
        {
            ...
            [
                new("2.6.122"),
                new("2.12.14"),
                new("3.0.25", supportedTargetFrameworks: ["net11.0", "net10.0"], supportedExecutionFrameworks: ["net11.0", "net10.0"]),
                new("3.1.0", supportedTargetFrameworks: ["net11.0", "net10.0"], supportedExecutionFrameworks: ["net11.0", "net10.0"]), // first version with the new internal ConnectImplAsync signature
                new("*", supportedTargetFrameworks: ["net11.0", "net10.0"], supportedExecutionFrameworks: ["net11.0", "net10.0"])
            ]
        },
        new()
        ...
        new()
        {
            ...
            Versions =
            [
                new("1.8.1", supportedTargetFrameworks: ["net11.0", "net10.0"], supportedExecutionFrameworks: ["net11.0", "net10.0"]),
                new("*", supportedTargetFrameworks: ["net11.0", "net10.0"], supportedExecutionFrameworks: ["net11.0", "net10.0"])
            ]
        }
    ];
