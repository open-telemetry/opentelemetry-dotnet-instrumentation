    ...
    [
        ...
        new()
        {
            ...
            [
                ...
                new("2.19.0", supportedTargetFrameworks: ["net11.0", "net10.0", "net9.0", "net8.0", "net462"], supportedExecutionFrameworks: ["net11.0", "net10.0", "net9.0", "net8.0", "net462"]),
                new("2.30.0", supportedTargetFrameworks: ["net11.0", "net10.0", "net9.0", "net8.0", "net462"], supportedExecutionFrameworks: ["net11.0", "net10.0", "net9.0", "net8.0", "net462"]),
                new("3.0.0", supportedTargetFrameworks: ["net11.0", "net10.0", "net9.0", "net8.0", "net472"], supportedExecutionFrameworks: ["net11.0", "net10.0", "net9.0", "net8.0", "net462"]),
                new("3.5.0", supportedTargetFrameworks: ["net11.0", "net10.0", "net9.0", "net8.0", "net472"], supportedExecutionFrameworks: ["net11.0", "net10.0", "net9.0", "net8.0", "net462"]),
                new("3.7.0", supportedTargetFrameworks: ["net11.0", "net10.0", "net9.0", "net8.0", "net472"], supportedExecutionFrameworks: ["net11.0", "net10.0", "net9.0", "net8.0", "net462"]), // first version with native OTel support
                new("*", supportedTargetFrameworks: ["net11.0", "net10.0", "net9.0", "net8.0", "net472"], supportedExecutionFrameworks: ["net11.0", "net10.0", "net9.0", "net8.0", "net462"])
            ]
        },
        new()
        {
        ...
        new()
        {
            ...
            [
                ...
                // new("6.0.13"), - transitive vulnerabilities https://github.com/advisories/GHSA-8g4q-xg66-9fp4 <= 6.0.12, <=7.0.10, <=8.0.4 test should be skipped
                // new("7.0.10"), - transitive vulnerabilities https://github.com/advisories/GHSA-8g4q-xg66-9fp4 <= 6.0.12, <=7.0.10, <=8.0.4 test should be skipped
                new("8.0.9"),
                new("9.0.4", supportedTargetFrameworks: ["net11.0", "net10.0", "net9.0", "net8.0"], supportedExecutionFrameworks: ["net11.0", "net10.0", "net9.0", "net8.0"]),
                new("*", supportedTargetFrameworks: ["net11.0", "net10.0", "net9.0", "net8.0"], supportedExecutionFrameworks: ["net11.0", "net10.0", "net9.0", "net8.0"])
            ]
        },
        new()
        {
            ...
            [
                ...
                new("9.2.10", supportedTargetFrameworks: ["net11.0", "net10.0", "net9.0", "net8.0"], supportedExecutionFrameworks: ["net11.0", "net10.0", "net9.0", "net8.0"]),
        ...
        new()
        {
            ...
            [
                new("2.6.122"),
                new("2.12.14"),
                new("3.0.25", supportedTargetFrameworks: ["net11.0", "net10.0", "net9.0", "net8.0"], supportedExecutionFrameworks: ["net11.0", "net10.0", "net9.0", "net8.0"]),
                new("3.1.0", supportedTargetFrameworks: ["net11.0", "net10.0", "net9.0", "net8.0"], supportedExecutionFrameworks: ["net11.0", "net10.0", "net9.0", "net8.0"]), // first version with the new internal ConnectImplAsync signature
                new("*", supportedTargetFrameworks: ["net11.0", "net10.0", "net9.0", "net8.0"], supportedExecutionFrameworks: ["net11.0", "net10.0", "net9.0", "net8.0"])
            ]
        },
        new()
        ...
        new()
        {
            ...
            [
                ...
                // net462: 10.0.12 (equal to instrumentation 10.0.12)
                // net10.0: 10.0.12 (framework override to 10.0.0, validates build parameter was respected)
                new("10.0.0", supportedTargetFrameworks: ["net8.0", "net9.0"], supportedExecutionFrameworks: ["net8.0", "net9.0"]),
                new("10.0.12", supportedTargetFrameworks: ["net462", "net11.0", "net10.0"], supportedExecutionFrameworks: ["net462", "net11.0", "net10.0"]),
            ]
        },
        new()
        {
            ...
            Versions =
            [
                new("1.8.1", supportedTargetFrameworks: ["net11.0", "net10.0", "net9.0", "net8.0"], supportedExecutionFrameworks: ["net11.0", "net10.0", "net9.0", "net8.0"]),
                new("*", supportedTargetFrameworks: ["net11.0", "net10.0", "net9.0", "net8.0"], supportedExecutionFrameworks: ["net11.0", "net10.0", "net9.0", "net8.0"])
            ]
        }
    ];
