...
xUnitFileStringBuilder.BeginClass(classNamespace: "IntegrationTests", className: "TestPackageVersions");
buildFileStringBuilder.BeginClass(classNamespace: string.Empty, className: "TestPackageVersions");
