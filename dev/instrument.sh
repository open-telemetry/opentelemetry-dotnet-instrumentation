...
export CORECLR_PROFILER_PATH="${ROOT_DIR}/src/Datadog.Trace.ClrProfiler.Native/bin/Debug/x64/OpenTelemetry.AutoInstrumentation.ClrProfiler.Native.${SUFIX}"
export OTEL_DOTNET_TRACER_HOME="${ROOT_DIR}/src/Datadog.Trace.ClrProfiler.Native/bin/Debug/x64"
export OTEL_INTEGRATIONS="${ROOT_DIR}/integrations.json"
